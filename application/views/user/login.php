...
<head>
  ...
  <link rel="icon" type="image/png" sizes="192x192" href="<?php echo base_url() ?>images/wizwingslogo.png">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form method="post" autocomplete="off" id="frm1" name="frm1">
      ...
      <div class="row">
        ...
        </div> | <a href='<?php echo base_url() ?>'>Register</a>
        <!-- /.col -->
      </div>
    </form>
