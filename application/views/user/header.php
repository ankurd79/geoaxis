...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url() ?>index.php/admin/index" class="logo">
      ...
      <span class="logo-lg"><b>User</b> <br><?php echo $site_config['site_name'] ?></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs"><?php echo $this->Common_model->userGreetings() ?>, <?php echo ucfirst($this->session->userdata('uname')); ?></span>
            </a>
            <ul class="dropdown-menu">
