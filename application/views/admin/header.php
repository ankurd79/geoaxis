...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url() ?>index.php/admin/index" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b> <br><?php echo $site_config['site_name'] ?></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs"><?php echo $this->Common_model->userGreetings() ?>, <?php echo ucfirst($this->session->userdata('pmail')); ?></span>
            </a>
            <ul class="dropdown-menu">
  ...
  <div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="chngpass" name="chngpass">
              <div class="box-body">
                <div class="form-group">
				  ...
				  <div class="col-sm-10" id="responsepass"></div>
                </div>
              </div>
